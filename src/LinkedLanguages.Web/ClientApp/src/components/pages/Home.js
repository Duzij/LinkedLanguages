      ...
      <div className='row d-flex align-items-center justify-content-center'>
        <div className='col-lg-4 col-md-12 col-sm-12'>
          <div className='d-flex flex-column align-items-end'>
            ...
            <small className="text-muted me-1">by <a href='https://openai.com/dall-e-2/' className='text-reset' target="_blank" rel="noreferrer">DALL·E</a></small>
          </div>
        </div>
        <div className='col-lg-6 col-md-12 col-sm-12'>
          <div className='align-items-start'>
            <h1>Welcome!</h1>
            <p>LinkedLanguages is a web application, which uses linked linguistic data as a database <a href="https://etytree.toolforge.org" target="_blank" rel="noreferrer">EtyTree</a> for in e-learning purposes.</p>

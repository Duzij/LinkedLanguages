...
namespace DamerauLevenshteinDistance.Console
{
    public static class ExtendedDamerauLevenshteinCalculator
    {
        public static int Calc(string a, string b, Dictionary<string, string> characterMapping)
        {
            ...
            for (int i = 1; i <= lengthA; i++)
                ...
                {
                    bool isMatch = AreCharactersEqual(b[j - 1].ToString(), a[i - 1].ToString(), characterMapping);

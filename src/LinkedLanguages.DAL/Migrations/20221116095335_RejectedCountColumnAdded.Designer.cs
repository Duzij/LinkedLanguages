...
namespace LinkedLanguages.DAL.Migrations
{
    ...
    [Migration("20221116095335_RejectedCountColumnAdded")]
    partial class RejectedCountColumnAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinkedLanguages.DAL.Models.LanguageOffset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LinkedLanguages.DAL.Models.WordPairToApplicationUser", b =>
                {
                    ...
                    b.Property<int>("NumberOfFailedSubmissions")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LinkedLanguages.DAL.Models.WordPair", b =>
                {
                    b.HasOne("LinkedLanguages.DAL.Models.Language", "KnownLanguage")
                        .WithMany()
                        .HasForeignKey("KnownLanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LinkedLanguages.DAL.Models.Language", "UnknownLanguage")
                        .WithMany()
                        .HasForeignKey("UnknownLanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("KnownLanguage");

                    b.Navigation("UnknownLanguage");
                });
